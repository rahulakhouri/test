...
class EmployeeUpdateLog(models.Model):
	action=models.OneToOneField('Action',related_name='update_log',on_delete="cascade")
	employee=models.ForeignKey('Employee',on_delete="cascade")
	is_new=models.BooleanField(default=False)
	new_name = models.CharField(max_length=100)
	new_dept = models.ForeignKey('Department',related_name='update_new_dept',on_delete="cascade")
	new_email = models.EmailField(max_length=75)
	new_is_active= models.BooleanField(default=True)
	old_name = models.CharField(max_length=100)
	old_dept = models.ForeignKey('Department',related_name='update_old_dept',on_delete="cascade")
...
class TransactionLog(models.Model):
	employee=models.ForeignKey('Employee',on_delete="cascade")
	action=models.ForeignKey('Action',null=True,on_delete="cascade")
	application=models.ForeignKey('Application',null=True,on_delete="cascade")
...
class Application(models.Model):
	...
	original= models.ForeignKey('self',null=True,on_delete="cascade")
